...
### ```c++ //============================================================================ // Name : Pointer6.cpp //同一個指標可以改變指標的指向位址，則其存取的位址和記憶體內容也會不同

include

using namespace std;

int main() { int n = 10; int m = 20; int p; p = &n; cout << "變數n的值=" << n << endl; cout << "指標p指向的記憶體位址=" << p << endl; cout << "p的值=" << *p << endl; cout << "-----------------------" << endl;
...
### ```c++ //============================================================================ // Name : callByRef1.cpp // Author : 傳參考呼叫

include

using namespace std; void turbo(int &); int main() { int speed; cout << "請輸入初始速度:"; cin >> speed;
...
void turbo(int &mySpeed){ cout << "加整前速度:" << mySpeed << endl; mySpeed+=10; } ```
